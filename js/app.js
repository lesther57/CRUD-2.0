...
function validarFormulario(e) {
    ...
    if (nombreInput.value === '' || apellidoInput.value === '' || edadInput.value === '' || carreraInput.value === '') {
...
function mostrarEstudiantes() {
    ...
    listaEstudiantes.forEach(estudiante => {
        ...
        editarBoton.classList.add('btn', 'boton-editar');
        parrafo.append(editarBoton);

        const eliminarBoton = document.createElement('button');
        eliminarBoton.onclick = () => eliminarEstudiante(id);
        eliminarBoton.textContent = 'Eliminar';
        eliminarBoton.classList.add('btn', 'boton-eliminar');
